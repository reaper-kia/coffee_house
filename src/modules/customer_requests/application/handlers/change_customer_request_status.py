        ...
        async with self.uow_factory() as uow:
            ...
            if customer_request.telegram_chat_id:
                event = create_customer_request_status_changed_event(
                    ...
                    new_status=(customer_request.status.value),
                    customer_telegram_chat_id=(customer_request.telegram_chat_id),
                    changed_by_admin_id=(command.changed_by_admin_id),
                    changed_at=(customer_request.updated_at),
