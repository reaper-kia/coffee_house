...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_notification_deliveries_customer_request_id"),
        "notification_deliveries",
        ["customer_request_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_processed_kafka_messages_consumer_group"),
        "processed_kafka_messages",
        ["consumer_group"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processed_kafka_messages_event_id"),
        "processed_kafka_messages",
        ["event_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_processed_kafka_messages_event_id"),
        table_name="processed_kafka_messages",
    )
    op.drop_index(
        op.f("ix_processed_kafka_messages_consumer_group"),
        table_name="processed_kafka_messages",
